...
import { Database, ListTodo, FileSearch, Calendar, BarChart3, Shield, ShieldCheck } from 'lucide-react';
...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'research' | 'projects' | 'integrations' | 'discovery' | 'citations' | 'pdf' | 'digest' | 'vault' | 'tracker' | 'summarizer' | 'calendar' | 'analysis' | 'sandbox' | 'deep-research'>('dashboard');
      ...
      <main className={cn("transition-all duration-300 ease-in-out min-h-screen", isSidebarOpen ? "pl-64" : "pl-0")}>
        ...
        <div className="p-8 max-w-7xl mx-auto">
          <AnimatePresence mode="wait">
            ...
            {activeTab === 'analysis' && <AnalysisAgent key="analysis" />}
